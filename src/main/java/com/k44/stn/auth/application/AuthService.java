...
public class AuthService {
    ...
    public AuthResponse login(LoginRequest request){
        ...
        if(!passwordEncoder.matches(passwordEncoder.encode(request.password()), user.getPasswordHash())) throw new ConflictException(ErrorCode.CONFLICT, "Неверный пароль");
